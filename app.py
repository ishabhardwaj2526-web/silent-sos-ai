...
st.write("Real-time voice detection logic ready hai. Demo ke liye button use karein")

def trigger_alert():
    st.error(f"🚨 DANGER DETECTED: 'HELP'")
...
st.markdown("---")
st.info("**Kaise kaam karta hai:** \n1. Mic hamesha background me sunta hai \n2. 'HELP' ya 'bachao' bolte hi turant SOS trigger \n3. Location + SMS + Call auto chale jate hai")
